...
{
    /// <summary>
    /// I found this class while looking up the problem documented in Utils_Meshes.cs.
    /// https://github.com/BlackxSnow/MaterialSafeMeshCombine/blob/main/MaterialSafeMeshCombine.cs
    /// </summary>
    /// <remarks>
    /// This class is not currently being used, as I ended up not needing it.
    /// The construction ghost simply needs to combine all the meshes into one and use a single material.
    /// However, this class combines them all, keeping all the original materials as separate submeshes.
    /// So I left this class here for now since it is useful.
    /// </remarks>
